  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-full max-w-md bg-slate-900 rounded-t-3xl sm:rounded-2xl border-t border-x sm:border border-purple-500/30 p-6 pb-8 shadow-2xl relative flex flex-col max-h-[90vh]"
      >
